...
# 尝试多个可能的路径
possible_paths = [
    os.path.join(script_dir, "../data/campus_data.csv"),  # 相对于脚本
    os.path.join(script_dir, "data/campus_data.csv"),
    os.path.join(os.getcwd(), "data/campus_data.csv"),    # 相对于运行目录
    os.path.join(os.getcwd(), "../data/campus_data.csv"),
    "F:/zuoye/ai_course_project/data/campus_data.csv",    # 绝对路径
